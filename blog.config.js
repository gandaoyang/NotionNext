...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OneFlowing一个节奏', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '你的节奏，你的专属生产力，你的财富源动力。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://oneflowing.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Founder@oneflowing.net', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@OneFlowing', // Youtube主页
